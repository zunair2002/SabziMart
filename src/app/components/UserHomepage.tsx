    ...
    const slides = [
        {
            id: 1,
            topText: "100% Natural",
            title: <>Fresh Smoothie & <span className="text-[#ffbb38]">Summer Juice</span></>,
        ...
        },
        {
            ...
            title: <>Fresh Fruits & <span className="text-[#ffbb38]">Vegetables</span></>,
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20 z-10">
                                <motion.span 
                                    ...
                                    className="text-[#ffbb38] font-bold text-sm md:text-lg mb-2"
                                >
                                ...
                                <motion.h1 
                                    ...
                                    className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-4 drop-shadow-lg"
                                >
                                ...
                                <motion.p 
                                    ...
                                    className="text-gray-200 text-sm md:text-base mb-8 max-w-md drop-shadow-md"
                                >
